 ...
 *
 * Безопасность: ключ кеша включает имя метода и botUserId, чтобы разные агрегаты
 * в одном cache namespace не пересекались и данные юзеров физически изолировались.
