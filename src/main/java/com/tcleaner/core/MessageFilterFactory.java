 ...
 *
 * <p>Устраняет дублирование логики построения фильтра между CLI-режимом и
 * {@link com.tcleaner.api.TelegramController}. Возвращает {@code null} если ни одно условие
